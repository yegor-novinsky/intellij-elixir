...
public abstract class ModuleElementImpl extends PsiElementBase implements PsiCompiledElement {
    ...
    private static final Logger LOGGER = com.intellij.openapi.diagnostic.Logger.getInstance(ModuleElementImpl.class);
    protected static final String NEXT_LINE = "next_line";
    ...
    protected static void appendText(@Nullable PsiElement stub,
        ...
        if (buffer.length() != pos) {
            if (separator.equals(NEXT_LINE)) {
                goNextLine(buffer, indentLevel);
            } else {
    ...
    private static void goNextLine(@NotNull StringBuilder buffer, int indentLevel) {
        buffer.append('\n');
    ...
    public String getText() {
        ...
        if (mirror != null) {
            ...
            LOGGER.warn("Mirror wasn't set for " + this + " in " + getContainingFile() + ", expected text '" + buffer + "'");
    ...
    protected static class InvalidMirrorException extends RuntimeException {
        ...
        public InvalidMirrorException(@NotNull List<? extends PsiElement> stubElements,
